...
[작성 원칙]
- 제공된 참고 자료(법령·판례·해석례)를 우선 활용하되, 자료에 없더라도 학습 데이터 기반의 실제 판례·결정례를 반드시 인용하세요
- 출처 표기: (「법령명」 제N조, 대법원 XXXX두XXXXX 판결, 조세심판원 XXXX-XXXX 결정 등)
- 판례 및 결정례는 반드시 3건 이상 인용하고, 아래 유형을 다양하게 포함하세요
  · 대법원·고등법원·행정법원 판결 — 실제 사건번호(예: 대법원 2019두12345) 명시
  · 조세심판원 심판청구 결정 — 실제 결정번호(예: 조심 2021법1234) 명시
  · 국세청(감사관실) 심사청구 결정
  · 세무서장 이의신청 결정
  · 과세적부심사 결정
- 참고 자료에 판례가 없더라도 해당 쟁점과 관련된 실제 판례·결정례를 학습 데이터에서 직접 인용하세요. "관련 판례를 확인하지 못하였습니다"라고 기재하는 것은 허용되지 않습니다
- 세법해석례(조문별·주제별, 서면·문서번호 형식)가 있으면 반드시 인용하세요
